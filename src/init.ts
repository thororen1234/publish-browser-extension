...
async function initChrome(
  ...
  console.log();
  consola.log('`--chrome-publisher-id` can be found in:');
  consola.log('  Developer Dashboard → Account section');
  consola.log('Example: `12345678-ab12-cd34-ef56-gh78ijkl`');
  ...
  console.log();
  consola.log(
    '`--chrome-client-id` and `--chrome-client-secret` can be created by following:',
  );
  console.log(
    'https://github.com/fregante/chrome-webstore-upload-keys/blob/main/readme.md',
  );
